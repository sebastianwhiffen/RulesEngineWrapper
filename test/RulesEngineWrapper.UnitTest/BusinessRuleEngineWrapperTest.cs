...
namespace RulesEngineWrapper.UnitTest
{
    ...
    public class BuisnessRulesTest
    {
        ...
        public async Task RulesEngine_Execute_Rule_For_Nested_Rule_Params_Returns_Success(string ruleFileName, bool fastExpressionEnabled)
        {
            ...
            var bre = new RulesEngineWrapper(JsonConvert.DeserializeObject<Workflow[]>(fileData), new RulesEngineWrapperSettings
            {
        ...
        public async Task ExecuteRule_RuntimeError_ThrowsException()
        {
            ...
            var re = new RulesEngineWrapper(new[] { workflow }, new RulesEngineWrapperSettings
            {
                ReSettings = new ReSettings
                {
        ...
        [Theory]
        [InlineData(typeof(RulesEngineWrapper), typeof(IRulesEngineWrapper))]
        ...
        private RulesEngineWrapper GetRulesEngine(string filename, RulesEngineWrapperSettings reSettings = null)
        {
