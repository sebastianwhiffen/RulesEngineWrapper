...
namespace RulesEngineWrapper.UnitTest
{
    ...
    public class BuisnessRulesTest
    {
        ...
        public async Task ExecuteRule_RuleWithMethodExpression_ReturnsSucess(string ruleFileName)
        {
            ...
            var re = GetRulesEngine(ruleFileName,
            x => x.UseRulesEngine(reSettings => reSettings.CustomTypes = new[] { typeof(Func<bool>) }));
        ...
        {
            var re = GetRulesEngine(ruleFileName, x => x.UseRulesEngine(reSettings => reSettings.EnableExceptionAsErrorMessage = true));
        ...
        public async Task ExecuteRuleWithIgnoreException_CompilationException_DoesNotReturnsAsErrorMessage(string ruleFileName)
        {
            var re = GetRulesEngine(ruleFileName,
             x => x.UseRulesEngine(reSettings =>
             {
                 ...
                 reSettings.IgnoreException = true;
             }));
        ...
        public async Task RulesEngineWithGlobalParam_RunsSuccessfully(string ruleFileName)
        {
            ...
            var re = GetRulesEngine(ruleFileName, x => x.UseRulesEngine());
